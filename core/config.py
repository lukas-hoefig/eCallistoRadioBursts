...
path_script = r"D:\programming\eCallistoRadioBursts"
path_data = r"D:\programming\eCallistoRadioBursts\eCallistoData"
path_realtime = r"D:\programming\robust_realtime_test"      # os.path.join(path_script, "realtime")
path_realtime_metadata = r"D:\programming\robust_realtime_test"
file_metadata = "burstlist.json"
foldernames_realtime = "%Y%m%d%H%M"
filenames_realtime = "%Y_%m_%d"
path_results = os.path.join(path_script, "results")
path_plots = os.path.join(path_script, "eCallistoPlots")
file_type = ".fit"
...
event_time_website = "%d.%m.%Y %H:%M:%S"
